...
function HeroSection() {
  return (
    <div id='home' className="relative text-black">
      ...
      >
        <SwiperSlide
          style={{ backgroundImage: `url(${sofaPhoto1})` }}
          className="bg-cover bg-center px-7 flex items-center justify-center text-5xl font-bold"
        >
        ...
        <SwiperSlide
          style={{ backgroundImage: `url(${sofaPhoto11})` }}
          className="bg-cover bg-center p-7 flex items-center justify-center text-5xl font-bold"
        >
        ...
        <SwiperSlide
          style={{ backgroundImage: `url(${sofaPhoto5})` }}
          className="p-7 bg-cover bg-center flex items-center justify-center text-5xl font-bold"
        >
